...
var AppController = /** @class */ (function () {
    ...
    AppController.prototype.getAnalyseTrack = function (track) {
        return __awaiter(this, void 0, void 0, function () {
            var audio, prediction, response, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.appService.getClassifier(track).then(function (res) {
                                prediction = res;
                                if (prediction.error) {
    ...
    AppController.prototype.dd = function (msg) {
    ...
    __decorate([
        ...
        __param(0, (0, common_1.Param)('track'))
    ], AppController.prototype, "getAnalyseTrack");
